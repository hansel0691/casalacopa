    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Book(string name, string lastName, string email, long checkIn, long checkOut, string country, int rooms, int adults, int children, string notes)
        {
            ...
            var toClientMsg = "<html style=\'padding:10px\'><body><style type=\'text/css\' media=\'screen\'>body{font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif;border: 1px solid #ddd;margin: auto;width: 550px;height: 600px;}" +
                ...
                "</section><section><h2>Personal Details</h2>Full Name: " + clientName + "<br>Country: " + country + "</section><section><h2>Booking Details</h2>Check in: " + dateIn.Date.ToShortDateString() + "<br>Check out: " + dateOut.Date.ToShortDateString() + "<br>Nights: " + nights + "<br>Number of Rooms: " + rooms + "<br>Price per night: " + _price + "<br>" +
                "Total Cost: " + totalCost + "</section><section><h2>House Details</h2>Phone number: 53 45612139, 53 54117832<br>Address: #125, 40 street between 1st and 3rd Avenue, Miramar, Playa, Cuba.<br>State: <i>Pendent to confirm.</i></section></article></body></html>";
            ...
            var toAdminMsg = "<html style=\'padding:10px\'><body><style type=\'text/css\' media=\'screen\'>body{font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif;border: 1px solid #ddd;margin: auto;width: 550px;height: 600px;}" +
                ...
                "<section><h2>Personal Details</h2>Full Name: " + clientName + "<br>Country: " + country + "</section><section><h2>Booking Details</h2>Check in: " + dateIn.Date.ToShortDateString() + "<br>Check out: " + dateOut.Date.ToShortDateString() + "<br>Nights: " + nights + "<br>Number of Rooms: " + rooms + "<br>Price per night: " + _price + "<br>" +
                "Total Cost: " + totalCost + "<br>Adults Number: " + adults + "<br>Children Number: " + children + "<br>Comments: " + (string.IsNullOrWhiteSpace(notes) ? "The Client didn't let a comment" : notes) + "</section></article></body></html>";
